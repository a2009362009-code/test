...
const MasterCard = ({ master }: { master: Master }) => (
  ...
  >
    ...
    <div className="p-5">
      ...
      <Link
        to={`/masters`}
        className="mt-4 flex w-full items-center justify-center rounded-lg bg-primary py-2.5 text-sm font-medium text-primary-foreground transition-all duration-150 hover:bg-primary/90 active:scale-[0.97]"
      >
        Записаться
      </Link>
    </div>
